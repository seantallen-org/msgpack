...
BUILD_DIR="build/msgpack-docs"
DOCS_DIR="${GEN_MD}/msgpack/${TAG}"
...
branch_name="msgpack-${TAG}"
git checkout -b "${branch_name}"
echo "Adding content..."
git add .
git commit -m "Add docs for package: msgpack version: ${TAG}"
